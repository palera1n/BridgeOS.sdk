...
*/
typedef struct CM_BRIDGED_TYPE(id) OpaqueCMTaggedBufferGroup *CMTaggedBufferGroupRef CF_REFINED_FOR_SWIFT API_AVAILABLE(macos(14.0), ios(17.0), bridgeos(8.0), tvos(17.0), watchos(10.0));

CM_EXPORT CFTypeID CMTaggedBufferGroupGetTypeID(void) CF_SWIFT_UNAVAILABLE("Unavailable in Swift") API_AVAILABLE(macos(14.0), ios(17.0), bridgeos(8.0), tvos(17.0), watchos(10.0));
...
*/
CM_EXPORT CMItemCount CMTaggedBufferGroupGetCount( CMTaggedBufferGroupRef CM_NONNULL group ) CF_REFINED_FOR_SWIFT API_AVAILABLE(macos(14.0), ios(17.0), bridgeos(8.0), tvos(17.0), watchos(10.0));
...
*/
CM_EXPORT CMTagCollectionRef CF_RETURNS_NOT_RETAINED CM_NULLABLE CMTaggedBufferGroupGetTagCollectionAtIndex( CMTaggedBufferGroupRef CM_NONNULL group, CFIndex index ) CF_REFINED_FOR_SWIFT API_AVAILABLE(macos(14.0), ios(17.0), bridgeos(8.0), tvos(17.0), watchos(10.0));
...
*/
CM_EXPORT CVPixelBufferRef CF_RETURNS_NOT_RETAINED CM_NULLABLE CMTaggedBufferGroupGetCVPixelBufferAtIndex( CMTaggedBufferGroupRef CM_NONNULL group, CFIndex index ) CF_REFINED_FOR_SWIFT API_AVAILABLE(macos(14.0), ios(17.0), bridgeos(8.0), tvos(17.0), watchos(10.0));
...
/*!
	...
	@result     Returns the CVPixelBuffer, or NULL on failure (including if the buffer at this index is not a CVPixelBuffer).
*/
CM_EXPORT CVPixelBufferRef CF_RETURNS_NOT_RETAINED CM_NULLABLE CMTaggedBufferGroupGetCVPixelBufferForTag( CMTaggedBufferGroupRef CM_NONNULL group, CMTag tag, CFIndex * CM_NULLABLE indexOut ) CF_SWIFT_UNAVAILABLE("Unavailable in Swift") API_AVAILABLE(macos(14.0), ios(17.0), bridgeos(8.0), tvos(17.0), watchos(10.0));
...
/*!
	...
	@result     Returns the CVPixelBuffer, or NULL on failure (including if the buffer at this index is not a CVPixelBuffer).
*/
CM_EXPORT CVPixelBufferRef CF_RETURNS_NOT_RETAINED CM_NULLABLE CMTaggedBufferGroupGetCVPixelBufferForTagCollection( CMTaggedBufferGroupRef CM_NONNULL group, CMTagCollectionRef CM_NONNULL tagCollection, CFIndex * CM_NULLABLE indexOut ) CF_SWIFT_UNAVAILABLE("Unavailable in Swift") API_AVAILABLE(macos(14.0), ios(17.0), bridgeos(8.0), tvos(17.0), watchos(10.0));
...
*/
CM_EXPORT CMSampleBufferRef CF_RETURNS_NOT_RETAINED CM_NULLABLE CMTaggedBufferGroupGetCMSampleBufferAtIndex( CMTaggedBufferGroupRef CM_NONNULL group, CFIndex index ) CF_REFINED_FOR_SWIFT API_AVAILABLE(macos(14.0), ios(17.0), bridgeos(8.0), tvos(17.0), watchos(10.0));
...
/*!
	...
	@result     Returns the CMSampleBuffer, or NULL on failure (including if the buffer at this index is not a CMSampleBuffer).
*/
CM_EXPORT CMSampleBufferRef CF_RETURNS_NOT_RETAINED CM_NULLABLE CMTaggedBufferGroupGetCMSampleBufferForTag( CMTaggedBufferGroupRef CM_NONNULL group, CMTag tag, CFIndex * CM_NULLABLE indexOut ) CF_SWIFT_UNAVAILABLE("Unavailable in Swift") API_AVAILABLE(macos(14.0), ios(17.0), bridgeos(8.0), tvos(17.0), watchos(10.0));
...
/*!
	...
	@result     Returns the CMSampleBuffer, or NULL on failure (including if the buffer at this index is not a CMSampleBuffer).
*/
CM_EXPORT CMSampleBufferRef CF_RETURNS_NOT_RETAINED CM_NULLABLE CMTaggedBufferGroupGetCMSampleBufferForTagCollection( CMTaggedBufferGroupRef CM_NONNULL group, CMTagCollectionRef CM_NONNULL tagCollection, CFIndex * CM_NULLABLE indexOut ) CF_SWIFT_UNAVAILABLE("Unavailable in Swift") API_AVAILABLE(macos(14.0), ios(17.0), bridgeos(8.0), tvos(17.0), watchos(10.0));
...
*/
CM_EXPORT CMItemCount CMTaggedBufferGroupGetNumberOfMatchesForTagCollection( CMTaggedBufferGroupRef CM_NONNULL group, CMTagCollectionRef CM_NONNULL tagCollection ) CF_SWIFT_UNAVAILABLE("Unavailable in Swift") API_AVAILABLE(macos(14.0), ios(17.0), bridgeos(8.0), tvos(17.0), watchos(10.0));
...
OSStatus CMTaggedBufferGroupFormatDescriptionCreateForTaggedBufferGroup(
	...
	CM_RETURNS_RETAINED_PARAMETER CMTaggedBufferGroupFormatDescriptionRef CM_NULLABLE * CM_NONNULL formatDescriptionOut) CF_REFINED_FOR_SWIFT API_AVAILABLE(macos(14.0), ios(17.0), bridgeos(8.0), tvos(17.0), watchos(10.0));
...
Boolean CMTaggedBufferGroupFormatDescriptionMatchesTaggedBufferGroup(
	...
	CMTaggedBufferGroupRef CM_NONNULL taggedBufferGroup) CF_REFINED_FOR_SWIFT API_AVAILABLE(macos(14.0), ios(17.0), bridgeos(8.0), tvos(17.0), watchos(10.0));
 ...
 */
CM_EXPORT CMTaggedBufferGroupRef CM_NULLABLE CMSampleBufferGetTaggedBufferGroup(CMSampleBufferRef CM_NONNULL sbuf) CF_REFINED_FOR_SWIFT API_AVAILABLE(macos(14.0), ios(17.0), bridgeos(8.0), tvos(17.0), watchos(10.0));
