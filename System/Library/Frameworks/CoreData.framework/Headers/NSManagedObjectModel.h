 ...
 */
@property (readonly, copy) NSString *versionChecksum API_AVAILABLE(macosx(14.0),ios(17.0), bridgeos(8.0),tvos(17.0),watchos(10.0));
...
+ (nullable NSDictionary<NSString *, NSString *> *)checksumsForVersionedModelAtURL:(NSURL *)modelURL
                                                                             error:(NSError **)error NS_REFINED_FOR_SWIFT API_AVAILABLE(macosx(14.0),ios(17.0), bridgeos(8.0),tvos(17.0),watchos(10.0));
