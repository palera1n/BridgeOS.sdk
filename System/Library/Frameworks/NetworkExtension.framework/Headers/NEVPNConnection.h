...
} API_AVAILABLE(macos(13.0), ios(16.0), bridgeos(7.0), tvos(17.0)) API_UNAVAILABLE(watchos);

/*! @const NEVPNConnectionErrorDomain The VPN connection error domain */
NEVPN_EXPORT NSString * const NEVPNConnectionErrorDomain API_AVAILABLE(macos(13.0), ios(16.0), bridgeos(7.0), tvos(17.0)) API_UNAVAILABLE(watchos);
 ...
 */
- (void)fetchLastDisconnectErrorWithCompletionHandler:(void (^)(NSError * _Nullable))handler API_AVAILABLE(macos(13.0), ios(16.0), bridgeos(7.0), tvos(17.0)) API_UNAVAILABLE(watchos);
