...
#define DEPRECATED_ATTRIBUTE_EXCLUDE_PUBLIC_IOS DEPRECATED_ATTRIBUTE  
#define __UNAVAILABLE_PUBLIC_IOS __API_AVAILABLE(macos(1.0)) 
...
__API_AVAILABLE(macos(12.0), ios(15.0), bridgeos(6.0), watchos(8.0), tvos(15.0));
