...
@property (nonatomic) NSGrammaticalCase grammaticalCase API_AVAILABLE(macos(14.0), ios(17.0), bridgeos(8.0), tvos(17.0), watchos(10.0));
@property (nonatomic) NSGrammaticalDetermination determination API_AVAILABLE(macos(14.0), ios(17.0), bridgeos(8.0), tvos(17.0), watchos(10.0));
@property (nonatomic) NSGrammaticalPerson grammaticalPerson API_AVAILABLE(macos(14.0), ios(17.0), bridgeos(8.0), tvos(17.0), watchos(10.0));
@property (nonatomic) NSGrammaticalPronounType pronounType API_AVAILABLE(macos(14.0), ios(17.0), bridgeos(8.0), tvos(17.0), watchos(10.0));
@property (nonatomic) NSGrammaticalDefiniteness definiteness API_AVAILABLE(macos(14.0), ios(17.0), bridgeos(8.0), tvos(17.0), watchos(10.0));
