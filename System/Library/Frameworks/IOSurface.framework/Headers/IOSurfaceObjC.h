...
extern IOSurfacePropertyKey IOSurfacePropertyKeyAllocSize                   API_AVAILABLE(macos(10.14), ios(12.0), bridgeos(3.0), watchos(5.0), tvos(12.0));

/* IOSurfacePropertyKeyWidth  - NSNumber for the width of the IOSurface buffer in pixels.   Required for planar IOSurfaces. */
extern IOSurfacePropertyKey IOSurfacePropertyKeyWidth                       API_AVAILABLE(macos(10.12), ios(11.0), bridgeos(2.0), watchos(4.0), tvos(11.0));

/* IOSurfacePropertyKeyHeight - NSNumber for the height of the IOSurface buffer in pixels.  Required for planar IOSurfaces. */
extern IOSurfacePropertyKey IOSurfacePropertyKeyHeight                      API_AVAILABLE(macos(10.12), ios(11.0), bridgeos(2.0), watchos(4.0), tvos(11.0));
...
extern IOSurfacePropertyKey IOSurfacePropertyKeyBytesPerRow                 API_AVAILABLE(macos(10.12), ios(11.0), bridgeos(2.0), watchos(4.0), tvos(11.0));
...
extern IOSurfacePropertyKey IOSurfacePropertyKeyBytesPerElement             API_AVAILABLE(macos(10.12), ios(11.0), bridgeos(2.0), watchos(4.0), tvos(11.0));

/* IOSurfacePropertyKeyElementWidth   - NSNumber for how many pixels wide each element is.   Defaults to 1. */ 
extern IOSurfacePropertyKey IOSurfacePropertyKeyElementWidth                API_AVAILABLE(macos(10.12), ios(11.0), bridgeos(2.0), watchos(4.0), tvos(11.0));

/* IOSurfacePropertyKeyElementHeight  - NSNumber for how many pixels high each element is.   Defaults to 1. */ 
extern IOSurfacePropertyKey IOSurfacePropertyKeyElementHeight               API_AVAILABLE(macos(10.12), ios(11.0), bridgeos(2.0), watchos(4.0), tvos(11.0));

/* IOSurfacePropertyKeyOffset - NSNumber for the starting offset into the buffer.  Defaults to 0. */
extern IOSurfacePropertyKey IOSurfacePropertyKeyOffset                      API_AVAILABLE(macos(10.12), ios(11.0), bridgeos(2.0), watchos(4.0), tvos(11.0));
...
extern IOSurfacePropertyKey IOSurfacePropertyKeyPlaneInfo                   API_AVAILABLE(macos(10.12), ios(11.0), bridgeos(2.0), watchos(4.0), tvos(11.0));

/* IOSurfacePropertyKeyPlaneWidth  - NSNumber for the width of this plane in pixels.  Required for image planes. */
extern IOSurfacePropertyKey IOSurfacePropertyKeyPlaneWidth                  API_AVAILABLE(macos(10.12), ios(11.0), bridgeos(2.0), watchos(4.0), tvos(11.0));

/* IOSurfacePropertyKeyPlaneHeight  - NSNumber for the height of this plane in pixels.  Required for image planes. */
extern IOSurfacePropertyKey IOSurfacePropertyKeyPlaneHeight                 API_AVAILABLE(macos(10.12), ios(11.0), bridgeos(2.0), watchos(4.0), tvos(11.0));
...
/* IOSurfacePropertyKeyPlaneBytesPerRow    - NSNumber for the bytes per row of this plane.  If not specified, IOSurface will first calculate
   ...
   That value will then be appropriately aligned. */
extern IOSurfacePropertyKey IOSurfacePropertyKeyPlaneBytesPerRow            API_AVAILABLE(macos(10.12), ios(11.0), bridgeos(2.0), watchos(4.0), tvos(11.0));
...
extern IOSurfacePropertyKey IOSurfacePropertyKeyPlaneOffset                 API_AVAILABLE(macos(10.12), ios(11.0), bridgeos(2.0), watchos(4.0), tvos(11.0));
...
extern IOSurfacePropertyKey IOSurfacePropertyKeyPlaneSize                   API_AVAILABLE(macos(10.12), ios(11.0), bridgeos(2.0), watchos(4.0), tvos(11.0));
...
extern IOSurfacePropertyKey IOSurfacePropertyKeyPlaneBase                   API_AVAILABLE(macos(10.12), ios(11.0), bridgeos(2.0), watchos(4.0), tvos(11.0));

/* IOSurfacePropertyKeyPlaneBytesPerElement    - NSNumber for the bytes per element of this plane.  Optional, default is 1. */
extern IOSurfacePropertyKey IOSurfacePropertyKeyPlaneBytesPerElement        API_AVAILABLE(macos(10.12), ios(11.0), bridgeos(2.0), watchos(4.0), tvos(11.0));

/* IOSurfacePropertyKeyPlaneElementWidth    - NSNumber for the element width of this plane.  Optional, default is 1. */
extern IOSurfacePropertyKey IOSurfacePropertyKeyPlaneElementWidth           API_AVAILABLE(macos(10.12), ios(11.0), bridgeos(2.0), watchos(4.0), tvos(11.0));

/* IOSurfacePropertyKeyPlaneElementHeight   - NSNumber for the element height of this plane.  Optional, default is 1. */
extern IOSurfacePropertyKey IOSurfacePropertyKeyPlaneElementHeight          API_AVAILABLE(macos(10.12), ios(11.0), bridgeos(2.0), watchos(4.0), tvos(11.0));
...
extern IOSurfacePropertyKey IOSurfacePropertyKeyCacheMode                   API_AVAILABLE(macos(10.12), ios(11.0), bridgeos(2.0), watchos(4.0), tvos(11.0));

/* IOSurfacePropertyKeyPixelFormat - NSNumber   A 32-bit unsigned integer that stores the traditional Mac OS X buffer format  */
extern IOSurfacePropertyKey IOSurfacePropertyKeyPixelFormat                 API_AVAILABLE(macos(10.12), ios(11.0), bridgeos(2.0), watchos(4.0), tvos(11.0));
...
extern IOSurfacePropertyKey IOSurfacePropertyKeyPixelSizeCastingAllowed     API_AVAILABLE(macos(10.12), ios(11.0), bridgeos(2.0), watchos(4.0), tvos(11.0));

/* IOSurfacePropertyKeyName - Provide a name for the surface at creation time. */
extern IOSurfacePropertyKey IOSurfacePropertyKeyName                        API_AVAILABLE(macos(13.0), ios(16.0), bridgeos(7.0), watchos(9.0), tvos(16.0));
