...
typedef NS_ENUM(NSInteger, AVSpeechSynthesisVoiceQuality) {
    ...
    AVSpeechSynthesisVoiceQualityPremium API_AVAILABLE(ios(16.0), bridgeos(7.0), macos(13.0), tvos(16.0), watchos(9.0))
...
typedef void (^AVSpeechSynthesizerMarkerCallback)(NSArray<AVSpeechSynthesisMarker *> *markers) NS_SWIFT_NAME(AVSpeechSynthesizer.MarkerCallback) API_AVAILABLE(ios(16.0), bridgeos(7.0), macos(13.0), watchos(9.0), tvos(16.0));
...
} NS_SWIFT_NAME(AVSpeechSynthesizer.PersonalVoiceAuthorizationStatus) API_AVAILABLE(ios(17.0), bridgeos(8.0), tvos(17.0), watchos(10.0), macos(14.0));
...
} NS_SWIFT_NAME(AVSpeechSynthesisVoice.Traits) API_AVAILABLE(ios(17.0), bridgeos(8.0), tvos(17.0), watchos(10.0), macos(14.0));
...
extern NSNotificationName AVSpeechSynthesisAvailableVoicesDidChangeNotification API_AVAILABLE(ios(17.0), bridgeos(8.0), tvos(17.0), watchos(10.0), macos(14.0));
...
@property(nonatomic, readonly) AVSpeechSynthesisVoiceGender gender API_AVAILABLE(ios(13.0), bridgeos(4.0), watchos(6.0), tvos(13.0), macos(10.15));
...
@property(nonatomic, readonly) NSDictionary<NSString *, id> *audioFileSettings API_AVAILABLE(ios(13.0), bridgeos(4.0), watchos(6.0), tvos(13.0), macos(10.15));

@property(nonatomic, readonly) AVSpeechSynthesisVoiceTraits voiceTraits API_AVAILABLE(ios(17.0), bridgeos(8.0), tvos(17.0), watchos(10.0), macos(14.0));
 ...
 */
+ (nullable instancetype)speechUtteranceWithSSMLRepresentation:(NSString *)string API_AVAILABLE(ios(16.0), bridgeos(7.0), macos(13.0), watchos(9.0), tvos(16.0));
...
/*!
 ...
 Returns nil if invalid SSML is passed in.
*/
- (nullable instancetype)initWithSSMLRepresentation:(NSString *)string API_AVAILABLE(ios(16.0), bridgeos(7.0), macos(13.0), watchos(9.0), tvos(16.0));
...
@property(nonatomic) BOOL prefersAssistiveTechnologySettings API_AVAILABLE(ios(14.0), bridgeos(5.0), watchos(7.0), tvos(14.0), macos(11.0));
...
- (void)writeUtterance:(AVSpeechUtterance *)utterance toBufferCallback:(AVSpeechSynthesizerBufferCallback)bufferCallback API_AVAILABLE(ios(13.0), bridgeos(4.0), watchos(6.0), tvos(13.0), macos(10.15)) ;
/*!
 ...
 The dictionary provided by -[AVSpeechSynthesisVoice audioFileSettings] can be used to create an AVAudioFile.
 */
- (void)writeUtterance:(AVSpeechUtterance *)utterance toBufferCallback:(AVSpeechSynthesizerBufferCallback)bufferCallback toMarkerCallback:(AVSpeechSynthesizerMarkerCallback)markerCallback API_AVAILABLE(ios(16.0), bridgeos(7.0), macos(13.0), watchos(9.0), tvos(16.0)) ;
...
/* The AVSpeechSynthesizer will use the AVAudioSession sharedInstance when set to YES.
   ...
   Default is YES. */
@property(nonatomic, assign) BOOL usesApplicationAudioSession API_AVAILABLE(ios(13.0), bridgeos(4.0), watchos(6.0), tvos(13.0), macCatalyst(14.0)) API_UNAVAILABLE(macos) ;
...
@property(nonatomic, assign) BOOL mixToTelephonyUplink API_AVAILABLE(ios(13.0), bridgeos(4.0), watchos(6.0)) API_UNAVAILABLE(tvos, macos);
 ...
 */
+ (void)requestPersonalVoiceAuthorizationWithCompletionHandler:(void(^)(AVSpeechSynthesisPersonalVoiceAuthorizationStatus status))handler API_AVAILABLE(ios(17.0), bridgeos(8.0), tvos(17.0), watchos(10.0), macos(14.0));
 ...
 */
@property (class, nonatomic, readonly) AVSpeechSynthesisPersonalVoiceAuthorizationStatus personalVoiceAuthorizationStatus API_AVAILABLE(ios(17.0), bridgeos(8.0), tvos(17.0), watchos(10.0), macos(14.0));
...
- (void)speechSynthesizer:(AVSpeechSynthesizer *)synthesizer willSpeakMarker:(AVSpeechSynthesisMarker *)marker utterance:(AVSpeechUtterance *)utterance API_AVAILABLE(ios(17.0), bridgeos(8.0), watchos(10.0), tvos(17.0), macos(14.0)) NS_AVAILABLE(14_0, 17_0);
@end
